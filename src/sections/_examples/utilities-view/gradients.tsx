        ...
        sx={[
          (theme) => ({
            ...theme.mixins.textGradient(
              `to right, ${theme.vars.palette.primary.light}, ${theme.vars.palette.primary.main}`
            ),
          }),
        ]}
      >
        ...
        sx={[
          (theme) => ({
            ...theme.mixins.borderGradient({
              padding: '4px',
              color: `linear-gradient(to right, ${theme.vars.palette.primary.main}, ${varAlpha(theme.vars.palette.primary.mainChannel, 0.2)})`,
            }),
            height: 160,
            borderRadius: 1.5,
            position: 'relative',
        ...
        <Box
          sx={[
            (theme) => ({
              ...theme.mixins.borderGradient({
                padding: '4px',
                color: `linear-gradient(to top, ${theme.vars.palette.secondary.main}, ${varAlpha(theme.vars.palette.primary.mainChannel, 0.2)})`,
              }),
            }),
          ]}
        />
      ...
      sx={[
        (theme) => ({
          ...theme.mixins.bgGradient({
            images: [
              `linear-gradient(135deg, ${varAlpha(theme.vars.palette.primary.lighterChannel, 0.8)}, ${varAlpha(theme.vars.palette.primary.mainChannel, 0.8)})`,
